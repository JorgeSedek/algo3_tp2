...
public class Jugador {
    ...
    public void moverVehiculo(Direccion direccion){
        ...
        System.out.println("El vehiculo del jugador: " + this.nombre + " esta en la fila: " + vehiculo.obtenerUbicacion().obtenerFila() + " columna: " + vehiculo.obtenerUbicacion().obtenerColumna());// TODO QUITAR MAS ADELANTE, SIRVE PARA DEBUGGEAR LA INTERFAZ GRAFICA
    }
