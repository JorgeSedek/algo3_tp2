...
public class App extends Application {
    ...
    public void leerInstrucciones() {
        ...
        TextArea textArea = new TextArea(
                ...
                + "El escenario es una ciudad y el objetivo, guiar un vehículo a la meta en la menor \ncantidad de movimientos posibles.\n"
                + "El juego se jugará por turnos, y en cada turno el usuario decide hacia cual de las 4 \nesquinas posibles avanzará.\n\n"
                ...
                + "Obstáculos\n\n"
                + "Al atravesar una cuadra el jugador se podrá encontrar con alguno de los \nsiguientes obstáculos:\n"
                + " * Pozo: Le suma 3 movimientos de penalización a autos y motos. Para una 4x4, \npenaliza en 2 movimientos luego de atravesar 3 pozos.\n"
                + " * Piquete: Autos y Camionetas deben pegar la vuelta, no pueden pasar. Las motos \npueden pasar con una penalización de 2 movimientos.\n"
                + " * Control Policial: Para todos los vehículos la penalización es de 3 movimientos, pero \nla probabilidad de que sea aplicada depende del vehículo.\n\n"
                ...
                + " * Cambio de Vehículo: Si es una moto, la convierte en auto. Un auto lo convierte en \nuna Camioneta. Una camioneta la convierte en moto.\n\n"
                + "Las sorpresas figuran en el mapa como un regalo y no se sabrá que es hasta que el \nvehículo la accione."
        );
